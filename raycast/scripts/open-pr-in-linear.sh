...
# @raycast.title Open PR in Linear
# @raycast.mode silent

# Optional parameters:
# @raycast.icon 🔗
# @raycast.packageName pr-navigation

# Documentation:
# @raycast.description Open the current GitHub or Graphite PR in Linear Review
...
target_url="https://linear.review/$owner/$repo/pull/$pr"
