...
// light gray (#c5c5c5) - to match cursor
const vec4 TRAIL_COLOR = vec4(0.773, 0.773, 0.773, 1.0);
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
// lighter gray (#eaeaea)
const vec4 TRAIL_COLOR_ACCENT = vec4(0.917, 0.917, 0.917, 1.0);
